...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "mywebapp" because\n';
  ...
  $wnd.__gwt_activeModules['mywebapp'] = {
    'moduleName' : 'mywebapp',
    'bindings' : function() {
      return {};
    }
 ...
 * "/mywebapp.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['mywebapp'].superdevmode = true;

  var expectedSuffix = '/mywebapp.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + mywebapp + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:mywebapp';
  var devModeSessionKey = '__gwtDevModeSession:mywebapp';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/mywebapp/mywebapp.nocache.js';
  ...
  $wnd.__gwt_activeModules['mywebapp'].canRedirect = true;
  $wnd.__gwt_activeModules['mywebapp'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/mywebapp?user.agent=' + ua + '&_callback=' + callback;
